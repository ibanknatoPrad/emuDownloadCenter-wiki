...
***
## About
![](https://github.com/PhoenixInteractiveNL/emuDownloadCenter/wiki/images_emulator/mega8_logo.jpg "Mega8 logo.")

**Developement state:** :white_circle: 2014

**Mega8** is a emulator for **Chip-8** made by **Ready4Next/Junta** and has a **Freeware** license, the GUI language is **English**.
