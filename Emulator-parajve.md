...
The latest version of the emulator on EDC is **0.7.0 (x86,x64)**, released on **2010-12-29**, it runs on **Windows XP,Vista,7,8,10**, you can start this emulator with **ParaJVE.exe**.
...
***
## Screenshot
![](https://raw.githubusercontent.com/PhoenixInteractiveNL/emuDownloadCenter/master/hooks/parajve/screen.jpg "Parabellum's Java Vectrex Emulator screenshot.")
***
## Downloads
| Version  | Release date  | Info       | Info       | DL Size    |
|:---------|:-------------:|:-----------|:-----------|-----------:|
| [:floppy_disk: **0.7.0**](https://github.com/PhoenixInteractiveNL/edc-repo0006/raw/master/parajve/0.7.0.7z) | 2010-12-29 | [:page_facing_up: Changelog](https://github.com/PhoenixInteractiveNL/edc-repo0006/blob/master/parajve/0.7.0_changelog.txt) | [:mag_right: Contents](https://github.com/PhoenixInteractiveNL/edc-repo0006/blob/master/parajve/0.7.0_contents.txt) | 7248 KB |
