...
***
## About
![](https://github.com/PhoenixInteractiveNL/emuDownloadCenter/wiki/images_emulator/sharpchip8_logo.jpg "SharpChip-8 logo.")

**Developement state:** :red_circle: 2011

**SharpChip-8** is a emulator for **Chip-8** made by **Yannick Comte aka Demonixis** and has a **GNU GPLv2** license, the GUI language is **French**.
